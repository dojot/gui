...
SidebarDevice.propTypes = {
    ...
    device: PropTypes.shape({
        ...
        dynamicValues: PropTypes.arrayOf(PropTypes.shape),
        staticValues: PropTypes.arrayOf(PropTypes.shape),
        actuatorValues: PropTypes.arrayOf(PropTypes.shape),
        created: PropTypes.string,
        id: PropTypes.string,
        label: PropTypes.string,
        static_attrs: PropTypes.arrayOf(PropTypes.shape),
